...
% --- icons: PDF-friendly vs LaTeXML-friendly ---
\providecommand{\faSyringe}{ICON-SYRINGE}
\providecommand{\faAmbulance}{ICON-AMBULANCE}
\usepackage{fontawesome5}

% Default: PDF (Overleaf)
\newcommand{\syringeicon}{\faSyringe}
\newcommand{\ambulanceicon}{\faAmbulance}

% LaTeXML: emit markers (to be replaced automatically by workflow)
\iflatexml
  \renewcommand{\syringeicon}{ICON-SYRINGE}
  \renewcommand{\ambulanceicon}{ICON-AMBULANCE}
\fi
...
% }
\title{Implementation of a framework to apply Sequential Analysis for Vaccine Safety Surveillance for23 SAEFVIC Dataset}
